...
//  XCTAssertEqual([parsedData respondsToSelector:@selector(objectForKey:)],
//  YES);
...
//  [parsedContent[@"transaction_type"]
//  isEqual:@(PREDTransactionTypeCompleted)];
//}
//
...
//  XCTAssertNotNil(parsedContent);
//  [parsedContent[@"transaction_type"]
//  isEqual:@(PREDTransactionTypeCancelled)];
