...
static BOOL doubleEqual(id obj1, id obj2) {
  return fabs([obj1 doubleValue] - [obj2 doubleValue]) <
         2 * DBL_EPSILON * fabs([obj1 doubleValue] + [obj2 doubleValue]);
}
...
- (void)testNetDiagSuccess1 {
  ...
  XCTestExpectation *expectation =
      [self expectationWithDescription:@"diagnosing"];
  [PREDNetDiag diagnose:@"http://www.baidu.com"
            persistence:_persistence
               complete:^(PREDNetDiagResult *result) {
  ...
  [parsedContent enumerateKeysAndObjectsUsingBlock:^(NSString *_Nonnull key,
                                                     id _Nonnull obj,
                                                     BOOL *_Nonnull stop) {
    XCTAssertTrue([[originalResult valueForKey:key] isEqual:obj] ||
                  doubleEqual([originalResult valueForKey:key], obj));
  }];
  [_persistence purgeAllNetDiag];
}
...
- (void)testNetDiagSuccess2 {
  ...
  XCTestExpectation *expectation =
      [self expectationWithDescription:@"diagnosing"];
  [PREDNetDiag diagnose:@"www.baidu.com"
            persistence:_persistence
               complete:^(PREDNetDiagResult *result) {
                 originalResult = result;
                 [expectation fulfill];
...
- (void)testNetDiagSuccess3 {
  ...
  XCTestExpectation *expectation =
      [self expectationWithDescription:@"diagnosing"];
  [PREDNetDiag diagnose:@"http://localhost"
            persistence:_persistence
               complete:^(PREDNetDiagResult *result) {
                 originalResult = result;
                 [expectation fulfill];
...
- (void)testNetDiagSuccess4 {
  ...
  XCTestExpectation *expectation =
      [self expectationWithDescription:@"diagnosing"];
  [PREDNetDiag diagnose:@"http://223.166.151.16"
            persistence:_persistence
               complete:^(PREDNetDiagResult *result) {
                 originalResult = result;
                 [expectation fulfill];
...
- (void)testNetDiagSuccess5 {
  ...
  XCTestExpectation *expectation =
      [self expectationWithDescription:@"diagnosing"];
  [PREDNetDiag diagnose:@"223.166.151.16"
            persistence:_persistence
               complete:^(PREDNetDiagResult *result) {
                 originalResult = result;
                 [expectation fulfill];
...
- (void)testNetDiagFail4 {
  ...
  XCTestExpectation *expectation =
      [self expectationWithDescription:@"diagnosing"];
  [PREDNetDiag diagnose:@"https://test.notfount.com"
            persistence:_persistence
               complete:^(PREDNetDiagResult *result) {
                 originalResult = result;
                 [expectation fulfill];
