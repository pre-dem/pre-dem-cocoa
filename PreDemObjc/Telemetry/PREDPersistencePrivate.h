...
@interface PREDPersistence ()

/**
 * The PREDPersistenceType determines if we have a bundle of meta data or telemetry that we want to safe.
 */
typedef NS_ENUM(NSInteger, PREDPersistenceType) {
    PREDPersistenceTypeTelemetry = 0,
    PREDPersistenceTypeMetaData = 1
};
 ...
 */
FOUNDATION_EXPORT NSString *const PREDPersistenceSuccessNotification;
...
@property (nonatomic, strong) NSString *appPreDemSDKDirectoryPath;
