 ...
 */
- (instancetype)initWithPersistence:(PREDPersistence *)persistence serverURL:(NSURL *)serverURL;
...
/**
 *  A queue which is used to handle PREDHTTPOperation completion blocks.
 */
