 ...
 */
- (instancetype)initWithPersistence:(PRESPersistence *)persistence serverURL:(NSURL *)serverURL;
...
/**
 *  A queue which is used to handle PRESHTTPOperation completion blocks.
 */
