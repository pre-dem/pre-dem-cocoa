...
/**
 ...
 This is the PreSniffSDK module that handles users, sessions and events tracking.
 ...
 */
@interface PRESMetricsManager : PRESBaseManager

/**
 *  A property indicating whether the PRESMetricsManager instance is disabled.
 */
