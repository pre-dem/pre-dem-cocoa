...
/**
 * The PRESPersistenceType determines if we have a bundle of meta data or telemetry that we want to safe.
 */
typedef NS_ENUM(NSInteger, PRESPersistenceType) {
    PRESPersistenceTypeTelemetry = 0,
    PRESPersistenceTypeMetaData = 1
};
 ...
 */
FOUNDATION_EXPORT NSString *const PRESPersistenceSuccessNotification;
...
@property (nonatomic, strong) NSString *appPreSniffSDKDirectoryPath;
