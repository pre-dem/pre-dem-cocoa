...
static void swizzle(Class classToSwizzle, SEL selector,
  ...
  // This block will be called by the client to get original implementation and
  // call it.
  ...
  // class_replaceMethod returns NULL and superclasses's implementation will be
  // used.
  //
