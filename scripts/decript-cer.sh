...
openssl aes-256-cbc -K $encrypted_6b87064fc261_key -iv $encrypted_6b87064fc261_iv -in scripts/profile/preengineeringPreDemObjcDemo_InHouse.mobileprovision.enc -out scripts/profile/preengineeringPreDemObjcDemo_InHouse.mobileprovision -d
